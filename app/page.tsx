...
export default function SKSAutoIndustries() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ["home", "contact", "about", "products", "legacy", "clients", "testimonials", "contact-form"] // Updated order
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white border-t border-gray-200 animate-in slide-in-from-top duration-200">
              <div className="px-2 pt-2 pb-3 space-y-1">
                {[
                  { id: "home", label: "Home" },
                  { id: "products", label: "Product Catalogue", href: "/#products" }, // Link to products section
            ...
            <div className="space-y-8 animate-in slide-in-from-left duration-1000">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 max-w-2xl">
                  Delivering premium quality automotive fasteners and components to India's leading manufacturers for
                  over 25 years. Based in Ludhiana, serving nationwide.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Ready to discuss your automotive component requirements? Contact us today for a personalized quote.
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Quick Contact Options</h3>
                ...
                <Button
                  onClick={() => {
                    ...
                    const message = encodeURIComponent(
                      `Hello SKS Auto Industries,

I am interested in your automotive fasteners and components. Please provide more information about:
...
Thank you!`,
                ...
                <Button
                  onClick={() => {
                    window.open("https://www.indiamart.com/sks-auto-industries-ludhiana/", "_blank")
                  }}
              ...
              <div className="mt-6 text-center">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  <span className="font-medium">Response Time:</span> Within 2 hours during business hours
                </p>
              </div>
            </div>
          </div>
          ...
          <div id="contact-form" className="grid lg:grid-cols-2 gap-12 mt-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@sksautoindustries.com</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <form className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input placeholder="+91 XXXXX XXXXX" className="w-full" />
                  </div>
                </div>
                <div>
                  ...
                  <select className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    ...
                    <option>Custom Fasteners</option>
                    <option>Other</option>
                  </select>
                </div>
                <div>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">About SKS Auto Industries</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Built on trust, driven by quality, and powered by innovation - we are your reliable partner in automotive
              manufacturing.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Established in 1998 in the industrial heart of Ludhiana, Punjab, SKS Auto Industries has grown from a
                  small workshop to one of India's most trusted manufacturers of automotive fasteners and components.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Our state-of-the-art factory spans over 50,000 sq ft, equipped with modern machinery and operated by
                  skilled craftsmen who understand the precision required in automotive manufacturing.
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Factory-Based Supply</h4>
                    <p className="text-sm text-gray-600">Direct from our manufacturing facility</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">500+ satisfied clients nationwide</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Quarter-century of excellence</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="products" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive range of automotive fasteners and components, manufactured to the highest standards of
      ...
      {/* Legacy Section */}
      <section id="legacy" className="py-20 bg-blue-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900 to-indigo-900"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">25+ Years of Manufacturing Excellence</h2>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              A legacy built on trust, innovation, and unwavering commitment to quality in the Indian automotive
              industry.
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Every product undergoes rigorous quality checks before dispatch</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-yellow-400 mt-1" />
                  <div>
                    ...
                    <p className="text-blue-100">Continuous investment in modern manufacturing technology</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-yellow-400 mt-1" />
                  <div>
                    ...
                    <p className="text-blue-100">Team of experienced craftsmen and quality engineers</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-yellow-400 mt-1" />
                  <div>
                    ...
                    <p className="text-blue-100">Serving automotive manufacturers across all major Indian cities</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="clients" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We're proud to supply premium automotive components to India's most respected manufacturers.
            </p>
          </div>
          ...
          <div className="md:hidden mb-16">
            <Marquee duration="40s">
              {clients.map((client, index) => (
                <div key={index} className="px-6 py-3 text-lg font-semibold text-gray-900 flex-shrink-0">
                  {client}
                </div>
              ))}
            </Marquee>
          ...
          <div className="bg-blue-50 rounded-2xl p-8 md:p-12">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Why Leading Manufacturers Choose Us</h3>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <Star className="w-5 h-5 text-yellow-500" />
                    <span className="text-gray-700">Consistent quality and on-time delivery</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Star className="w-5 h-5 text-yellow-500" />
                    <span className="text-gray-700">Competitive pricing with bulk order discounts</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Star className="w-5 h-5 text-yellow-500" />
                    <span className="text-gray-700">Custom manufacturing capabilities</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Star className="w-5 h-5 text-yellow-500" />
              ...
              <div className="text-center">
                ...
                <div className="text-lg font-semibold text-gray-900 mb-2">Client Retention Rate</div>
                <p className="text-gray-600">Our clients trust us for repeat orders year after year</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
                <CardContent className="p-0 flex-1 flex flex-col">
                  ...
                  <p className="text-gray-600 mb-6 italic flex-1">{testimonial.testimonial}</p>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                India's trusted manufacturer of premium automotive fasteners and components. Serving the industry with
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} SKS Auto Industries. All rights reserved. | Designed for excellence in
