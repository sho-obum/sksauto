...
import oilsealImg from "../public/OilSeal.jpg";
import fuelInjectorImg from "../public/fuel_injector.jpg";
import inkectorSeal from "../public/injectorSeal.jpg";
import fuelValveImg from "../public/fuel_valve.jpg";
import oRingImg from "../public/orings.png";
import bushImg from "../public/bushes.png";
...
const defaultItems: ProductCard[] = [
  {
    id: "oil-seal",
    title: "Oil Seal",
    subtitle: "High-temp NBR, leak-proof",
    image: oilsealImg,
  },
  {
    id: "o-ring",
    title: "O-Ring",
    subtitle: "Precision elastomer rings",
    image: oRingImg,
  },
  {
    id: "injector-seal",
    title: "Injector Seal",
    subtitle: "Tight fit, consistent flow",
    image: inkectorSeal,
  },
  {
    id: "bushes",
    title: "Bushes",
    subtitle: "Durable wear resistance",
    image: bushImg,
  },
  {
    id: "rubber-boot",
    title: "Rubber Boot",
    subtitle: "Protective bellows, OEM spec",
    image: ph("Rubber Boot"),
  },
  {
    id: "fuel-valve",
    title: "Fuel Valve",
    subtitle: "Reliable sealing performance",
    image: fuelValveImg,
  },
  {
    id: "fuel-injector",
    title: "Fuel Injector",
    subtitle: "Consistent atomization",
    image: fuelInjectorImg,
  },
];
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 p-4">
          ...
          <div className="relative flex items-end justify-between gap-3">
            <div className="min-w-0">
              <h3 className="text-white text-2xl font-semibold leading-tight truncate">
                {item.title}
              </h3>
